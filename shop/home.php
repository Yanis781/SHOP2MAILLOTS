...
<html>
    ...
    <head>
        ...
        <title>SHOP2MAILLOTS { Home }</title>
            ...
            <div class="barre-reassurance">
                ...
                <div class="reassurance-item">
                    ...
                    <div class="icone-ronde">
                        <img src="../ressources/images/icon-tshirt.png" alt="icon Qualité" width="100px" height="100px">
                    </div> 
                ...
                <div class="reassurance-item">
                    ...
                    <div class="icone-ronde">
                        <img src="../ressources/images/icon-web.png" alt="icon Qualité" width="100px" height="100px">
                    </div>
                ...
                <div class="reassurance-item">
                    ...
                    <div class="icone-ronde">
                        <img src="../ressources/images/icon-phone.png" alt="icon Qualité" width="100px" height="100px">
                    </div>
                ...
                <div class="reassurance-item">
                    ...
                    <div class="icone-ronde">
                        <img src="../ressources/images/icon-reload.png" alt="icon Qualité" width="100px" height="100px">
                    </div>
